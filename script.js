...
let keyboardHeatMapGenerator = {
	...
	this.keyboard = [
	    ...
	    {name:['q'], x:1.25, y:2.25, width:1, height:1},
	    {name:['w'], x:2.25, y:2.25, width:1, height:1},
	    {name:['f'], x:3.25, y:2.25, width:1, height:1},
	    {name:['p'], x:4.25, y:2.25, width:1, height:1},
	    {name:['b'], x:5.25, y:2.25, width:1, height:1},
	    {name:['j'], x:6.25, y:2.25, width:1, height:1},
	    {name:['l'], x:7.25, y:2.25, width:1, height:1},
	    {name:['u'], x:8.25, y:2.25, width:1, height:1},
	    {name:['y'], x:9.25, y:2.25, width:1, height:1},
	    {name:[';'], x:10.25, y:2.25, width:1, height:1},
	    {name:['['], x:11.25, y:2.25, width:1, height:1},
	    {name:[']'], x:12.25, y:2.25, width:1, height:1},
	    {name:['|'], x:13.25, y:2.25, width:1.75, height:1},
	    // Third row
	    {name:['CAPSLOCK'], x:0, y:3.25, width:1.5, height:1},
	    {name:['a'], x:1.5, y:3.25, width:1, height:1},
	    {name:['r'], x:2.5, y:3.25, width:1, height:1},
	    {name:['s'], x:3.5, y:3.25, width:1, height:1},
	    {name:['t'], x:4.5, y:3.25, width:1, height:1},
	    {name:['g'], x:5.5, y:3.25, width:1, height:1},
	    {name:['m'], x:6.5, y:3.25, width:1, height:1},
	    {name:['n'], x:7.5, y:3.25, width:1, height:1},
	    {name:['e'], x:8.5, y:3.25, width:1, height:1},
	    {name:['i'], x:9.5, y:3.25, width:1, height:1},
	    {name:['o'], x:10.5, y:3.25, width:1, height:1},
	    {name:['"'], x:11.5, y:3.25, width:1, height:1},
	    // {name:['*'], x:12.5, y:3.25, width:1, height:1},
	    {name:['ENTER'], x:12.5, y:3.25, width:2.5, height:1},
	    // Fourth row
	    {name:['S'], x:0, y:4.25, width:2.25, height:1},
	    {name:['x'], x:2.25, y:4.25, width:1, height:1},
	    {name:['c'], x:3.25, y:4.25, width:1, height:1},
	    {name:['d'], x:4.25, y:4.25, width:1, height:1},
	    {name:['v'], x:5.25, y:4.25, width:1, height:1},
	    {name:['z'], x:6.25, y:4.25, width:1, height:1},
	    {name:['k'], x:7.25, y:4.25, width:1, height:1},
	    {name:['h'], x:8.25, y:4.25, width:1, height:1},
